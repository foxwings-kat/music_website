...
<span style="font-size:480%; background:orange">我的歌曲</span>
<img src="https://steamuserimages-a.akamaihd.net/ugc/960853363633424461/4C0E46016EE7ABF8440FCA7B9B5AB60EF55AA969/"
style="width:120px;height:85px"/>
...
<tr>
    ...
    <th width="20%" ><a style="font-size:120%;" href="uploadpage.html"><big>上傳歌曲</big></a></th>
	<th width="20%" ><a style="font-size:120%;" href="deletesong.php"><big>刪除歌曲</big></a></th>
    <th width="20%"><a style="font-size:120%;" href="myplaylist.php"><big>我的播放清單</big></a></th>
...
$sql = "SELECT * FROM songdata where uploader = '$user_id'";
